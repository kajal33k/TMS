...
<body class="bg-gradient-to-r from-[#108291ee] via-gray-900 to-[#2d7a73] min-h-screen flex items-center justify-center p-6">
    <div class="bg-white bg-opacity-10 backdrop-blur-lg border border-white border-opacity-20 rounded-2xl shadow-lg p-8 max-w-lg w-full">
        ...
        <form action="submit_feedback.php" method="POST">
            ...
            <button type="submit" class="w-full p-3 rounded-lg bg-[#108291ee] text-white font-semibold hover:bg-[#34727ab8] transition">Submit Feedback</button>
        </form>
    </div>
</body>
</html>
